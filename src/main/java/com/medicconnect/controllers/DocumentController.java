...
import com.medicconnect.repositories.DocumentRepository;
...
public class DocumentController {
    ...
    public ResponseEntity<List<Document>> getDocumentsByPerson(@PathVariable Long personId) {
        Person person = personService.findById(personId);
    ...
    public ResponseEntity<List<Document>> getDocumentsByOrganization(@PathVariable Long orgId) {
        Organization org = organizationService.getOrganizationById(orgId);
    ...
    public ResponseEntity<List<Document>> getVerifiedDocumentsByPerson(@PathVariable Long personId) {
        Person person = personService.findById(personId);
    ...
    public ResponseEntity<List<Document>> getVerifiedDocumentsByOrganization(@PathVariable Long orgId) {
        Organization org = organizationService.getOrganizationById(orgId);
