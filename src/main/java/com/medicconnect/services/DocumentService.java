...
public class DocumentService {
    ...
    public Document linkDocumentToPerson(Long documentId, Person person) {
    ...
    public Document linkDocumentToOrganization(Long documentId, Organization organization) {
        Document document = documentRepository.findById(documentId)
                .orElseThrow(() -> new RuntimeException("Document not found"));
